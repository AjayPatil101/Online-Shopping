      ...
      <div className="flex items-center">
        <div className="w-[5rem] h-[5rem] lg:w-[9rem] lg:h-[9rem]">
          <img
            ...
            src="https://rukminim1.flixcart.com/image/612/612/xif0q/jean/n/q/y/-original-imaghzuqgugbczzc.jpeg?q=70"
            alt=""
            srcset=""
          />
        </div>
        <div className="ml-5 space-y-1">
          <p className="font-semibold">Men Regular Low Rise Blue Jeans</p>
